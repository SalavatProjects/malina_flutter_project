  ...
  double _calculateTotalPrice() {
    ...
    if (cartItems.isNotEmpty) {
      for (ProductEntity product in productsBySubcategory) {
        quantity =
            cartItems
                .firstWhereOrNull((e) => e.productId == int.parse(product.id))
                ?.quantity ??
            0;
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: Text(
                  productsBySubcategory[0].subcategory,
                  style: AppStyles.wixMadeforDisplayW400GreyDim(
                  ...
                  cartItems
                      .firstWhereOrNull(
                        (e) =>
                            ...
                            productsBySubcategory[index].id,
                      )
                      ?.quantity ??
                  0;
              return Column(
                children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: productsBySubcategory[index].imagePath != null
                              ? DecorationImage(
                                  image: AssetImage(
                                    productsBySubcategory[index].imagePath!,
                                  ),
                                )
                              : null,
                        ),
                            ...
                            children: [
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      child: Text(
                                        productsBySubcategory[index].name,
                                    ...
                                    Text(
                                      "${productsBySubcategory[index].price} C",
                                      style:
                                          AppStyles.wixMadeforDisplayW500AlmostBlack(
                              ...
                              Expanded(
                                child: SizedBox(
                                  ...
                                  child: Text(
                                    productsBySubcategory[index].description,
                                    style: AppStyles.wixMadeforDisplayW400Grey(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style:
                                          AppStyles.wixMadeforDisplayW700AlmostBlack(
                                            context.isLandscape ? AppFontSizes.sp18 : AppFontSizes.sp16,
                                          ),
                                    ),
                                    SizedBox(width: 8.w),
                  ...
                  if (productsBySubcategory[index].category ==
                      ProductCategory.food)
                    Padding(
                      padding: EdgeInsets.only(top: 14.w),
                      child: _AdditivitiesButton(
                        onPressed: () {
                          onAdditivitiesPressed?.call(
                            int.parse(productsBySubcategory[index].id),
                          );
                        },
                      ),
                    ),
...
class _IncreaseDecreaseButton extends StatelessWidget {
  ...
  const _IncreaseDecreaseButton({required this.icon, required this.onPressed});
  ...
  Widget build(BuildContext context) {
    return CupertinoButton(
      ...
      child: Container(
        ...
        child: Icon(
          icon,
          size: context.isLandscape ? 16.w : 13.w,
...
class _AdditivitiesButton extends StatelessWidget {
  ...
  const _AdditivitiesButton({required this.onPressed});
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 8.w),
          Text(
            t.cart.additivies.toCapitalize(),
            style: AppStyles.wixMadeforDisplayW400AlmostBlack(
              context.isLandscape ? AppFontSizes.sp18 : AppFontSizes.sp16,
            ),
          ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Text(
            t.cart.total.toCapitalize(),
            style: AppStyles.wixMadeforDisplayW500White(
              context.isLandscape ? AppFontSizes.sp18 : AppFontSizes.sp16,
            ),
          ),
          Text(
            "${totalPrice.toStringAsFixed(2)} C",
            style: AppStyles.wixMadeforDisplayW500White(
              context.isLandscape ? AppFontSizes.sp18 : AppFontSizes.sp16,
            ),
          ),
