...
@override
String toString() {
  return 'UserEntity(id: $id, email: $email, passwordHash: $passwordHash, loginAttempts: $loginAttempts)';
}
...
class _UserEntity implements UserEntity {
  const _UserEntity({required this.id, required this.email, required this.passwordHash, required this.loginAttempts});
